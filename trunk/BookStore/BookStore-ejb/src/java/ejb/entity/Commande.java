...
@NamedQueries({
    ...
    @NamedQuery(name = "Commande.findByLivreid", query = "SELECT c FROM Commande c WHERE c.commandePK.livreid = :livreid"),
    @NamedQuery(name = "Commande.findByJournalId", query = "SELECT c FROM Commande c WHERE c.commandePK.journalId = :journalId"),
    ...
    @NamedQuery(name = "Commande.findByCommandedatelivraison", query = "SELECT c FROM Commande c WHERE c.commandedatelivraison = :commandedatelivraison"),
    @NamedQuery(name = "Commande.findByCommandequantite", query = "SELECT c FROM Commande c WHERE c.commandequantite = :commandequantite"),
    @NamedQuery(name = "Commande.findByCommandeetat", query = "SELECT c FROM Commande c WHERE c.commandeetat = :commandeetat")})
