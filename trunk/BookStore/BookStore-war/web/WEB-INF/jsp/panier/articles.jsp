            ...
            <div>
                ...
                <c:if test="${sessionScope['scopedTarget.session'].client.clientid!=null}">
                    ...
                    <fieldset>
                        ...
                        <br/>
                        <br/>
                        <span class="error" id="erreurCarte"> ${messageCarte}</span><br/>
                        Carte de crédit:<input type="text" id="carte" size="10"/>
                        <input type="button" id="terminer" value="Terminer votre Commande" />
